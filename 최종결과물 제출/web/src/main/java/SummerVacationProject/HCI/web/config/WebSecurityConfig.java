...
public class WebSecurityConfig {
    ...
    public WebSecurityCustomizer configure() {
        return (web) -> web.ignoring()
                .requestMatchers("/static/**", "/css/**", "/js/**", "/images/**", "/uploadFile/**");
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        .requestMatchers("/", "/index", "/login", "/join", "/Gallery/list", "/Gallery/{id}", "/Gallery/post/{postId}",
                                "/MinorGallery/list", "/MinorGallery/{id}", "/MinorGallery/post/{postId}",
                                "/myPage", "/member-info/{id}","/champions", "/search").permitAll()
